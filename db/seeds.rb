...
track1.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '01_something_good.mp3')), filename: "01_something_good.mp3")
...
track2.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '02_out_of_town.mp3')), filename: "02_out_of_town.mp3")
...
track3.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '03_pick_me_up.mp3')), filename: "03_pick_me_up.mp3")
...
track4.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '04_501c3_blues.mp3')), filename: "04_501c3_blues.mp3")
...
track5.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '05_big_break.mp3')), filename: "05_big_break.mp3")
...
track6.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '06_beatles_in_my_dreams.mp3')), filename: "06_beatles_in_my_dreams.mp3")
...
track7.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '07_problem_1.mp3')), filename: "07_problem_1.mp3")
...
track8.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '08_friend_visit.mp3')), filename: "08_friend_visit.mp3")
...
track9.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '09_how_long.mp3')), filename: "09_how_long.mp3")
...
track10.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '10_for_another_day.mp3')), filename: "10_for_another_day.mp3")
...
track11.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '11_i_was_asleep.mp3')), filename: "11_i_was_asleep.mp3")
...
track12.track.attach(io: File.open(Rails.root.join('app', 'assets', 'audio', '12_dogwood.mp3')), filename: "12_dogwood.mp3")
