...
class SingleTrackDisplay extends React.Component{
  constructor(props){
    super(props);
  ...
  render(){
    let track = this.props.trackArtistPair[0];
    let artist = this.props.trackArtistPair[1];
...
export default connect(null, mapDispatchToProps)(SingleTrackDisplay);